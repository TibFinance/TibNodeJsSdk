...
* @returns object 
   */
static listServices(sessionToken,
merchantId)
    {
...
* @returns object 
   */
static getService(sessionToken,
serviceId,
merchantId)
    {
...
* @returns object 
   */
static getWalletInformationsByService(sessionToken,
serviceId)
    {
...
* @returns object 
   */
static listMerchants(sessionToken,
serviceId,
merchantId,
...
* @returns object 
   */
static getServiceBoardingStatus(sessionToken,
boardingServiceId)
    {
...
* @returns object 
   */
static createMerchant(sessionToken,
serviceId,
merchantInfo)
    {
...
* @returns object 
   */
static getMerchant(sessionToken,
merchantId)
    {
...
* @returns object 
   */
static saveMerchant(sessionToken,
merchantId,
merchantInfo)
    {
...
* @returns object 
   */
static saveMerchantBasicInfo(sessionToken,
merchantId,
merchantInfo)
    {
...
* @returns object 
   */
static saveMerchantAccountInfo(sessionToken,
merchantId,
account)
    {
...
* @returns object 
   */
static deleteMerchant(sessionToken,
merchantId)
    {
...
* @returns object 
   */
static getMerchantsByExternalId(sessionToken,
externalSystemId,
...
* @returns object 
   */
static adjustWallet(sessionToken,
serviceId,
merchantId,
amount,
mode,
...
* @returns object 
   */
static listCustomers(sessionToken,
serviceId,
merchantId)
    {
...
* @returns object 
   */
static createCustomer(sessionToken,
serviceId,
customer)
    {
...
* @returns object 
   */
static getCustomer(sessionToken,
customerId,
merchantId)
    {
...
* @returns object 
   */
static saveCustomer(sessionToken,
customer,
merchantId)
    {
...
* @returns object 
   */
static deleteCustomer(sessionToken,
customerId)
    {
...
* @returns object 
   */
static getCustomersByExternalId(sessionToken,
externalCustomerId,
merchantId)
    {
...
* @returns object 
   */
static listPaymentMethods(sessionToken,
customerId,
merchantId)
    {
...
* @returns object 
   */
static createCreditCardPaymentMethod(sessionToken,
currency,
customerId,
...
* @returns object 
   */
static createDirectAccountPaymentMethod(sessionToken,
customerId,
isCustomerAutomaticPaymentMethod,
account,
language)
...
* @returns object 
   */
static createInteracPaymentMethod(sessionToken,
customerId,
isCustomerAutomaticPaymentMethod,
interacInformation,
language,
...
* @returns object 
   */
static getPaymentMethod(sessionToken,
paymentMethodId)
    {
...
* @returns object 
   */
static deletePaymentMethod(sessionToken,
paymentMethodId)
    {
...
* @returns object 
   */
static setDefaultPaymentMethod(sessionToken,
customerId,
paymentMethodId)
    {
...
* @returns object 
   */
static createBill(sessionToken,
billData,
...
* @returns object 
   */
static deleteBill(sessionToken,
billId,
merchantId)
    {
...
* @returns object 
   */
static listTransfers(sessionToken,
paymentFilterLevel,
levelFilterId,
markResolvedOnly,
fromDate,
...
* @returns object 
   */
static listTransfersFast(sessionToken,
fromDate,
toDate,
serviceId,
merchantId,
...
* @returns object 
   */
static listTransfersForBillFast(sessionToken,
merchantId,
billId)
    {
...
* @returns object 
   */
static getRecuringTransfers(sessionToken,
serviceId)
    {
...
* @returns object 
   */
static deleteRecuringTransfer(sessionToken,
recuringTransferId)
    {
...
* @returns object 
   */
static createPayment(sessionToken,
billId,
...
* @returns object 
   */
static getPayment(sessionToken,
paymentId)
    {
...
* @returns object 
   */
static deletePayment(sessionToken,
paymentId)
    {
...
* @returns object 
   */
static createDirectInteracTransaction(sessionToken,
merchantId,
interacInformation,
transferDirection,
dueDate,
...
* @returns object 
   */
static createTransactionFromRaw(sessionToken,
rawAcpFileContent,
merchantId)
    {
...
* @returns object 
   */
static listExecutedOperations(sessionToken,
fromDate,
toDate,
transferType,
transferGroupId,
...
* @returns object 
   */
static forcePaymentProcess(sessionToken,
paymentId)
    {
...
* @returns object 
   */
static getDropInPublicToken(sessionToken,
merchantId,
customerId,
billId,
amount,
...
* @returns object 
   */
static createFreeOperationBatch(sessionToken,
groupId,
stopSameIdentifications)
    {
...
* @returns object 
   */
static revertTransfer(sessionToken,
transferId)
    {
...
* @returns object 
   */
static changeInteracPaymentMethodQuestionAndAnswer(sessionToken,
...
* @returns object 
   */
static initBoarding(sessionToken,
serviceId)
    {
...
* @returns object 
   */
static createSubClient(sessionToken,
name,
language,
currency)
    {
...
* @returns object 
   */
static resendPaymentEmail(sessionToken,
paymentId,
merchantId)
    {
...
* @returns object 
   */
static relaunchMerchantFailedTransfer(sessionToken,
transferId,
merchantId)
    {
...
* @returns object 
   */
static createSupplierTransfer(sessionToken,
merchantId,
amount,
transferDueDate,
targetMerchantId,
...
* @returns object 
   */
static getSuppliers(sessionToken,
merchantId)
    {
...
* @returns object 
   */
static createSupplier(sessionToken,
merchantId,
supplierName,
supplierEmail,
currency,
...
* @returns object 
   */
static getWalletOperations(sessionToken,
serviceId,
from,
to)
    {
